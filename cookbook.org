...
Close the year
#+begin_src
hledger -f 2024.journal close --close type:ALE --close-acct=Equity:Closing-Balances -e 2025 -x --show-costs
#+end_src

Open the next year
#+begin_src sh
hledger -f 2024.journal close --open type:ALE --close-acct=Equity:Closing-Balances -e 2025 -x --show-costs
#+end_src
