...
Close the year
#+begin_src
hledger -f 2025-closed.journal close --close type:ALEV --close-acct=Equity:Opening-Balances -e 2026 -x --show-costs
#+end_src

Open the next year
#+begin_src sh
hledger -f 2025-closed.journal close --open type:ALEV --close-acct=Equity:Opening-Balances -e 2026 -x --show-costs
#+end_src
...
* Receivables
** Loans
Suppose I lent money to someone and expect a refund later. This amount lent
...
#+begin_src sh
hledger close --retain --close-acct=Equity:Earnings:Retained
#+end_src
